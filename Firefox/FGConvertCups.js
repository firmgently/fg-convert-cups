...
*/
  wrapMatchedText = function(str, match) {
/*    var
    spanStrText = document.createElement("span"),
    spanMatchText = document.createElement("span"),
    nodeStrText = document.createTextNode(str),
    nodeMatchText = document.createTextNode(match);

    spanMatchText.addChild(nodeMatchText);

    spanStrText.className += ' fg-converted-cup';
    spanStrText.addChild(nodeStrText);
    spanStrText.addChild(spanMatchText);
    return spanStrText;*/
  ...
  replaceTextInNode = function(node) {
    ...
    for (i = lastChildNodeIndex; i >= 0; i--){
      ...
      if (matchFound) {
        //
        //
        // child.parentElement.innerHTML = html;
        //
        //
        ...
        // remove child
        // create new element of type ?? on parentElement
        // add new element in same position as removed child
      }
    }
  };
